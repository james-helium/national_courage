#This file is to combine all data sources together
#and add external control datasets according to our pre-registration

#Note: some dependent measures should be manually added in;
#the dependent measures (apart from IDV from WVS) are all from "indexes"
#- they are available only as digital web-shots, which requires manual add-ins
...
IPUMS_Edu_Urb <- read.csv('data/ipumsi_00003.csv')
